...
exports.HentaiScantradVFInfo = {
    ...
    sourceTags: [{ text: 'FR', type: types_1.BadgeColor.GREY }],
    intents: types_1.SourceIntents.MANGA_CHAPTERS | types_1.SourceIntents.HOMEPAGE_SECTIONS | types_1.SourceIntents.CLOUDFLARE_BYPASS_REQUIRED
};
class HentaiScantradVF extends base_1.Madara {
    base_url = DOMAIN;
    lang_code = 'FR';
    source_path = 'manga';
    alt_ajax = true;
...
exports.HentaiScantradVF = HentaiScantradVF;
